...
class ListAdmin(admin.ModelAdmin):
    list_display = ('event', 'open', 'count', 'limit', 'rate')
    ...
    def export(self, request, object_id):
        ...
        response['Content-Disposition'] = 'attachment; filename=elenco-iscritti-%s.csv' % slugify(obj.event.title)
...
class InscriptionEntryAdmin(admin.ModelAdmin):
    list_display = ('rank', 'full_name', 'first_name', 'last_name', 'timestamp', event, 'enrolled', 'confirmation_sent')
