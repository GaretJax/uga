...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InscriptionEntry.confirmation_sent'
        db.add_column('inscriptions_inscriptionentry', 'confirmation_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InscriptionEntry.confirmation_sent'
        db.delete_column('inscriptions_inscriptionentry', 'confirmation_sent')
