...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Membership', fields ['person', 'year']
        db.create_unique('registration_membership', ['person_id', 'year_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Membership', fields ['person', 'year']
        db.delete_unique('registration_membership', ['person_id', 'year_id'])

        # Changing field 'Membership.date_joined'
        db.alter_column('registration_membership', 'date_joined', self.gf('django.db.models.fields.DateField')())
